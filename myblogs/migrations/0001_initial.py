...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'myblogs_blogentry', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('body', self.gf('django.db.models.fields.TextField')(max_length=1000)),
            ('published_on', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True)),
            ('last_edited', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['myjobs.User'])),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seo.SeoSite'])),
        ))
        db.send_create_signal(u'myblogs', ['BlogEntry'])

        # Adding M2M table for field tags on 'BlogEntry'
        m2m_table_name = db.shorten_name(u'myblogs_blogentry_tags')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('blogentry', models.ForeignKey(orm[u'myblogs.blogentry'], null=False)),
            ('tag', models.ForeignKey(orm[u'mypartners.tag'], null=False))
        ))
        db.create_unique(m2m_table_name, ['blogentry_id', 'tag_id'])


    def backwards(self, orm):
        # Deleting model 'BlogEntry'
        db.delete_table(u'myblogs_blogentry')

        # Removing M2M table for field tags on 'BlogEntry'
        db.delete_table(db.shorten_name(u'myblogs_blogentry_tags'))
    ...
    models = {
        ...
        u'myblogs.blogentry': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['myjobs.User']"}),
            ...
            'published_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'null': 'True'}),
