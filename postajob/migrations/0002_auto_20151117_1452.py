...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='request',
            name='related_sites',
            field=models.ManyToManyField(to='seo.SeoSite', null=True),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='productgrouping',
            name='products',
            field=models.ManyToManyField(help_text=b'The products you want displayed with this grouping.', to='postajob.Product', null=True, through='postajob.ProductOrder'),
        ),
        migrations.AddField(
            model_name='product',
            name='owner',
        ...
        migrations.AddField(
            model_name='companyprofile',
            name='customer_of',
            field=models.ManyToManyField(related_name='customer', null=True, to='seo.Company', blank=True),
        ),
        migrations.AddField(
