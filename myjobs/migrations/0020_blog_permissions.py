...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        blog = AppAccess.objects.create(name='Blog')
        blog_activities = [
            ('create blog entry', 'Add new blog entry.'),
            ('update blog entry', 'Edit existing blog entry.'),
            ('delete blog entry', 'Delete existing blog entry.')
        ]

        for name, desc in blog_activities:
            Activity.objects.create(
                app_access=blog, name=name, description=desc)

    def backwards(self, orm):
        app = orm.AppAccess.objects.get(name='Blog')
        orm.Activity.objects.filter(app_access=blog).delete()
    ...
    models = {
        ...
        u'myjobs.secondpartyaccessrequest': {
            'Meta': {'object_name': 'SecondPartyAccessRequest'},
            'accepted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'account_owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['myjobs.User']"}),
            'account_owner_email': ('django.db.models.fields.EmailField', [], {'max_length': '255', 'db_index': 'True'}),
            'acted_on': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'db_index': 'True'}),
            'expired': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'reason': ('django.db.models.fields.TextField', [], {}),
            'second_party': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['myjobs.User']"}),
